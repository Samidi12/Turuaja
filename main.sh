...
clear;clear;clear
echo -e " ${CYAN} ┌─────────────────────────────────────────────────┐${NC}"
echo -e " ${CYAN} │ ${BG_RED}               LANDEAN TUNNEL                  ${NC} ${CYAN}│$NC"
echo -e " ${CYAN} └─────────────────────────────────────────────────┘${NC}"
echo ""
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Samidi12/Turuaja/main/REGIST | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Samidi12/Turuaja/main/REGIST | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
wget raw.githubusercontent.com/arivpnstores/v3/mainfiles/limit.sh && chmod +x limit.sh && ./limit.sh
cd
